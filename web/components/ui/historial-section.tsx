...
const ACCION_CONFIG: Record<HistorialEntry["accion"], { label: string; color: string; icon: string }> = {
  ...
  estado_cambiado:{ label: "Estado",          color: "text-[#E5A100]",        icon: "M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" },
    ...
    <div className="mt-1">
      ...
      {updatedAt && updatedAt !== createdAt && (
        <p className="mt-2 text-[10px] text-sse-muted">
          Última modificación: {new Date(updatedAt).toLocaleString("es-SV", { dateStyle: "medium", timeStyle: "short" })}
        </p>
      )}
    </div>
  );
