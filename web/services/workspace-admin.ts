...
const MOCK_SETTINGS: Record<WorkspaceId, WorkspaceSettings> = {
  ...
  isp: {
    wsId: "isp",
    nombre: "Identity & Security Platform",
    nombreCorto: "ISP",
    descripcion: "Plataforma centralizada de identidad y seguridad. Gestión de usuarios, roles RBAC, permisos, sesiones y auditoría de acceso. Única autoridad de autenticación y autorización. Preparada para integración con Google OAuth (Sprint 013).",
    responsableId: "USR-VRAF-001",
    color: "#1E3A8A",
    colorFondo: "#EFF6FF",
    icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
  ...
  gwp: {
    wsId: "gwp",
    nombre: "Google Workspace Platform",
    nombreCorto: "GWP",
    descripcion: "Plataforma de integración con Google Workspace. Gateway único para Identity (OAuth 2.0), Drive, Gmail, Calendar y Chat. Tokens obfuscados en servidor, CSRF via PropertiesService, clientSecret nunca expuesto al cliente.",
    responsableId: "USR-VRAF-001",
    color: "#0F9D58",
    colorFondo: "#F0FDF4",
  ...
  iia: {
    wsId: "iia",
    nombre: "Institutional Intelligence Assistant",
    nombreCorto: "IIA",
    descripcion: "Asistente de Inteligencia Institucional impulsado por Gemini. Gateway exclusivo de IA de la plataforma: consultas en lenguaje natural, acciones supervisadas, análisis de indicadores y síntesis ejecutiva. Sin agentes autónomos ni datos externos.",
    responsableId: "USR-VRAF-001",
    color: "#4F46E5",
    colorFondo: "#EEF2FF",
    icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z",
  ...
  ice: {
    wsId: "ice",
    nombre: "Indicator Capture Engine",
    nombreCorto: "ICE",
    descripcion: "Motor operativo de captura de variables de indicadores. Los responsables registran variables por período; el sistema calcula automáticamente el resultado usando FormulaEngine, evalúa el rango y lo enruta al flujo de aprobación. Sprint 018.",
    responsableId: "USR-VRAF-001",
    color: "#0284C7",
    colorFondo: "#F0F9FF",
